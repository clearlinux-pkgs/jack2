...
Version  : 1.9.19
Release  : 9
URL      : https://github.com/jackaudio/jack2/archive/v1.9.19/jack2-1.9.19.tar.gz
Source0  : https://github.com/jackaudio/jack2/archive/v1.9.19/jack2-1.9.19.tar.gz
...
%prep
%setup -q -n jack2-1.9.19
cd %{_builddir}/jack2-1.9.19
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627509725
...
cp %{_builddir}/jack2-1.9.19/COPYING %{buildroot}/usr/share/package-licenses/jack2/db95910cb27890d60e596e4c622fc3eeba6693fa
cp %{_builddir}/jack2-1.9.19/android/NOTICE %{buildroot}/usr/share/package-licenses/jack2/56775a72fbc8b1416c51326851d83c2121a92c98
%make_install
