...
Source0  : https://github.com/jackaudio/jack2/archive/v1.9.20/jack2-1.9.20.tar.gz
...
%prep
%setup -q -n jack2-1.9.20
cd %{_builddir}/jack2-1.9.20
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642637391
...
cp %{_builddir}/jack2-1.9.20/COPYING %{buildroot}/usr/share/package-licenses/jack2/db95910cb27890d60e596e4c622fc3eeba6693fa
cp %{_builddir}/jack2-1.9.20/android/NOTICE %{buildroot}/usr/share/package-licenses/jack2/56775a72fbc8b1416c51326851d83c2121a92c98
%make_install
